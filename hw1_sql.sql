...
-- 21. Вывести пользователя у которых id меньше 127 или больше 138
SELECT * FROM students where id< 127 or id>138;
...
SELECT id,name,created_on FROM students ORDER BY created_on ASC;1
